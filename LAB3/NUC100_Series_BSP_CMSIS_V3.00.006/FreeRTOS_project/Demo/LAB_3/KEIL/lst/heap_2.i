...
#line 63 "..\\..\\..\\Source\\portable\\MemMang\\heap_2.c"
...
#line 70 "..\\..\\..\\Source\\portable\\MemMang\\heap_2.c"
...
#line 71 "..\\..\\..\\Source\\portable\\MemMang\\heap_2.c"
...
static union xRTOS_HEAP
{
	...
	unsigned char ucHeap[ ( ( size_t ) ( 13 * 1024 ) ) ];
} xHeap;
...
static size_t xFreeBytesRemaining = ( ( size_t ) ( 13 * 1024 ) );
...
#line 131 "..\\..\\..\\Source\\portable\\MemMang\\heap_2.c"
 

#line 152 "..\\..\\..\\Source\\portable\\MemMang\\heap_2.c"
...
void *pvReturn = 0;
	...
	vTaskSuspendAll();
	{
		...
		{
			{ xBlockLink *pxFirstFreeBlock; xStart . pxNextFreeBlock = ( void * ) xHeap . ucHeap; xStart . xBlockSize = ( size_t ) 0; xEnd . xBlockSize = ( ( size_t ) ( 13 * 1024 ) ); xEnd . pxNextFreeBlock = 0; pxFirstFreeBlock = ( void * ) xHeap . ucHeap; pxFirstFreeBlock->xBlockSize = ( ( size_t ) ( 13 * 1024 ) ); pxFirstFreeBlock->pxNextFreeBlock = &xEnd; };
		...
		if( ( xWantedSize > 0 ) && ( xWantedSize < ( ( size_t ) ( 13 * 1024 ) ) ) )
		{
...
#line 239 "..\\..\\..\\Source\\portable\\MemMang\\heap_2.c"

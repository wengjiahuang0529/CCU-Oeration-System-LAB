...
#line 70 "..\\..\\..\\Source\\include\\queue.h"
...
#line 27 "..\\partA.c"
#line 1 "..\\..\\..\\Source\\include\\semphr.h"
...
#line 1261 "..\\..\\..\\Source\\include\\queue.h"

#line 62 "..\\..\\..\\Source\\include\\semphr.h"
...
#line 115 "..\\..\\..\\Source\\include\\semphr.h"
...
int main(void)
{
		...
		for(i = 0; i < 4; i++)
			Chopstick[i] = xQueueCreateCountingSemaphore( 1, 1 );
		
		
		xTaskGenericCreate( ( philosopher_A ), ( 0 ), ( ( ( unsigned short ) 128 ) ), ( 0 ), ( 1 ), ( 0 ), ( 0 ), ( 0 ) );
		...
		xTaskGenericCreate( ( philosopher_B ), ( 0 ), ( ( ( unsigned short ) 128 ) ), ( 0 ), ( 1 ), ( 0 ), ( 0 ), ( 0 ) );
		...
		xTaskGenericCreate( ( philosopher_C ), ( 0 ), ( ( ( unsigned short ) 128 ) ), ( 0 ), ( 1 ), ( 0 ), ( 0 ), ( 0 ) );
		...
		xTaskGenericCreate( ( philosopher_D ), ( 0 ), ( ( ( unsigned short ) 128 ) ), ( 0 ), ( 1 ), ( 0 ), ( 0 ), ( 0 ) );
...
void pick_chopstick(int philosopher_index)
{
    ...
    xQueueGenericReceive( ( xQueueHandle ) Chopstick[left_chopstick_index], 0, ( portTickType ) 0xffffffff, ( 0 ) );
    ...
    xQueueGenericReceive( ( xQueueHandle ) Chopstick[right_chopstick_index], 0, ( portTickType ) 0xffffffff, ( 0 ) );
...
void release_chopstick(int philosopher_index)
{
    ...
    xQueueGenericSend( ( xQueueHandle ) Chopstick[left_chopstick_index], 0, ( ( portTickType ) 0 ), ( 0 ) );
    
     
    xQueueGenericSend( ( xQueueHandle ) Chopstick[right_chopstick_index], 0, ( ( portTickType ) 0 ), ( 0 ) );
}
...
void eating_rice(int philo){
	...
	(*((volatile uint32_t *)(((((( uint32_t)0x50000000) + 0x4000) + 0x0200)+(0x40*(2))) + ((12 + philo)<<2)))) = 0; 
	vTaskDelay(1000);
	(*((volatile uint32_t *)(((((( uint32_t)0x50000000) + 0x4000) + 0x0200)+(0x40*(2))) + ((12 + philo)<<2)))) = 1; 
...
{
	int temp;
	xQueueGenericReceive( ( xQueueHandle ) Mutex, 0, ( portTickType ) 0xffffffff, ( 0 ) );
	temp = ScanKey();
	xQueueGenericSend( ( xQueueHandle ) Mutex, 0, ( ( portTickType ) 0 ), ( 0 ) );
	return temp;
}

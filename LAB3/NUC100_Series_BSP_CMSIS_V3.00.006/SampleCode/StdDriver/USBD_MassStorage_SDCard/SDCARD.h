 ...
 * @file     sdcard.h
 * @version  V1.00
 * @brief    NUC100 series SD Card driver header file
 *
 * @note
...
/** @addtogroup NUC100_Library NUC100 Library
  @{
*/

/** @addtogroup NUC100_SDCARD SDCARD Library
  @{
*/

/** @addtogroup NUC100_SDCARD_EXPORTED_CONSTANTS SDCARD Library Exported Constants
  @{
*/
...
#define BACK_FROM_ERROR { SingleWrite(0xFF); PE7 = 1;  return FALSE;} /*!< macro for SPI write */
...
/*@}*/ /* end of group NUC100_SDCARD_EXPORTED_CONSTANTS */

/** @addtogroup NUC100_SDCARD_EXPORTED_STRUCTS SDCARD Library Exported Structs
  @{
*/
...
/*@}*/ /* end of group NUC100_SDCARD_EXPORTED_STRUCTS */

/** @addtogroup NUC100_SDCARD_EXPORTED_FUNCTIONS SDCARD Library Exported Functions
  @{
*/
...
/*@}*/ /* end of group NUC100_SDCARD_EXPORTED_FUNCTIONS */


/*@}*/ /* end of group NUC100_SDCARD */

/*@}*/ /* end of group NUC100_Library */

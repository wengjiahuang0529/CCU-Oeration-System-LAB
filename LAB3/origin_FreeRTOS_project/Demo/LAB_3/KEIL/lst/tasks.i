...
#line 89 "..\\..\\..\\Source\\include\\StackMacros.h"
 

#line 106 "..\\..\\..\\Source\\include\\StackMacros.h"
 

#line 123 "..\\..\\..\\Source\\include\\StackMacros.h"
 

#line 145 "..\\..\\..\\Source\\include\\StackMacros.h"
 

#line 170 "..\\..\\..\\Source\\include\\StackMacros.h"
 



#line 67 "..\\..\\..\\Source\\tasks.c"
...
typedef struct tskTaskControlBlock
{
 ...
 static xList pxReadyTasksLists[ ( ( unsigned long ) 6 ) ];	 
 ...
 static xList xPendingReadyList;							 
	 ...
	 static volatile unsigned long uxTasksDeleted = ( unsigned long ) 0;
 ...
 static volatile unsigned long uxCurrentNumberOfTasks 	= ( unsigned long ) 0;
 static volatile portTickType xTickCount 						= ( portTickType ) 0;
 static unsigned long uxTopUsedPriority	 				= ( ( unsigned long ) 0 );
 static volatile unsigned long uxTopReadyPriority 		= ( ( unsigned long ) 0 );
 static volatile signed long xSchedulerRunning 			= ( 0 );
 static volatile unsigned long uxSchedulerSuspended	 	= ( unsigned long ) ( 0 );
 static volatile unsigned long uxMissedTicks 			= ( unsigned long ) 0;
 static volatile long xMissedYield 						= ( long ) ( 0 );
 static volatile long xNumOfOverflows 					= ( long ) 0;
 static unsigned long uxTaskNumber 						= ( unsigned long ) 0;

#line 172 "..\\..\\..\\Source\\tasks.c"
...
#line 492 "..\\..\\..\\Source\\tasks.c"
	...
	tskTCB *pxTCB;
		...
		vPortEnterCritical();
		{
			...
			pxTCB = ( ( pxTaskToDelete == 0 ) ? ( tskTCB * ) pxCurrentTCB : ( tskTCB * ) pxTaskToDelete );
	...
	{
	tskTCB *pxTCB;
	unsigned long uxCurrentPriority, xYieldRequired = ( 0 );

		 
		if( uxNewPriority >= ( ( unsigned long ) 6 ) )
		{
			uxNewPriority = ( ( unsigned long ) 6 ) - 1;
		}
		...
		vPortEnterCritical();
		{
			...
			if( uxCurrentPriority != uxNewPriority )
			{
				...
				( &( pxTCB->xEventListItem ) )->xItemValue = ( ( ( unsigned long ) 6 ) - ( portTickType ) uxNewPriority );
...
long xReturn;
	...
	xReturn = xTaskGenericCreate( ( prvIdleTask ), ( ( signed char * ) "IDLE" ), ( ( ( unsigned short ) 128 ) ), ( ( void * ) 0 ), ( ( ( ( unsigned long ) 0 ) | ( ( unsigned long ) 0x00 ) ) ), ( ( xTaskHandle * ) 0 ), ( 0 ), ( 0 ) );
...
signed long xAlreadyYielded = ( 0 );
	...
	vPortEnterCritical();
	{
		...
		if( uxSchedulerSuspended == ( unsigned long ) ( 0 ) )
		{
			if( uxCurrentNumberOfTasks > ( unsigned long ) 0 )
			{
				long xYieldRequired = ( 0 );

				
 
				while( ( pxTCB = ( tskTCB * ) ( ( ( ( xList * ) &xPendingReadyList )->uxNumberOfItems != ( unsigned long ) 0 ) ? ( (&( ( ( xList * ) &xPendingReadyList )->xListEnd ))->pxNext->pvOwner ) : ( 0 ) ) ) != 0 )
				{
					vListRemove( &( pxTCB->xEventListItem ) );
					vListRemove( &( pxTCB->xGenericListItem ) );
					{ if( pxTCB->uxPriority > uxTopReadyPriority ) { uxTopReadyPriority = pxTCB->uxPriority; } vListInsertEnd( ( xList * ) &( pxReadyTasksLists[ pxTCB->uxPriority ] ), &( pxTCB->xGenericListItem ) ); };
				...
				if( uxMissedTicks > ( unsigned long ) 0 )
				{
					while( uxMissedTicks > ( unsigned long ) 0 )
					{
						vTaskIncrementTick();
						--uxMissedTicks;
					}
...
#line 1247 "..\\..\\..\\Source\\tasks.c"
 

#line 1312 "..\\..\\..\\Source\\tasks.c"
 

#line 1329 "..\\..\\..\\Source\\tasks.c"
 

#line 1347 "..\\..\\..\\Source\\tasks.c"
...
void vTaskIncrementTick( void )
{
	...
	if( uxSchedulerSuspended == ( unsigned long ) ( 0 ) )
	{
		...
		{ register tskTCB *pxTCB; while( ( pxTCB = ( tskTCB * ) ( ( pxDelayedTaskList->uxNumberOfItems != ( unsigned long ) 0 ) ? ( (&( pxDelayedTaskList->xListEnd ))->pxNext->pvOwner ) : ( 0 ) ) ) != 0 ) { if( xTickCount < ( ( &( pxTCB->xGenericListItem ) )->xItemValue ) ) { break; } vListRemove( &( pxTCB->xGenericListItem ) ); if( pxTCB->xEventListItem . pvContainer ) { vListRemove( &( pxTCB->xEventListItem ) ); } { if( pxTCB->uxPriority > uxTopReadyPriority ) { uxTopReadyPriority = pxTCB->uxPriority; } vListInsertEnd( ( xList * ) &( pxReadyTasksLists[ pxTCB->uxPriority ] ), &( pxTCB->xGenericListItem ) ); }; } };
	}
	else
	{
		++uxMissedTicks;
...
#line 1393 "..\\..\\..\\Source\\tasks.c"
	}

#line 1407 "..\\..\\..\\Source\\tasks.c"

	;
}
 

#line 1463 "..\\..\\..\\Source\\tasks.c"
 

#line 1489 "..\\..\\..\\Source\\tasks.c"
 

#line 1518 "..\\..\\..\\Source\\tasks.c"
 

#line 1550 "..\\..\\..\\Source\\tasks.c"
...
long xReturn;
	...
	pxUnblockedTCB = ( tskTCB * ) ( ( pxEventList->uxNumberOfItems != ( unsigned long ) 0 ) ? ( (&( pxEventList->xListEnd ))->pxNext->pvOwner ) : ( 0 ) );
...
#line 1798 "..\\..\\..\\Source\\tasks.c"
...

		{
			...
			if( ( ( &( pxReadyTasksLists[ ( ( unsigned long ) 0 ) ] ) )->uxNumberOfItems ) > ( unsigned long ) 1 )
			{
				vPortYieldFromISR();
			}
		}
...
static void prvInitialiseTCBVariables( tskTCB *pxTCB, const signed char * const pcName, unsigned long uxPriority, const xMemoryRegion * const xRegions, unsigned short usStackDepth )
{
	...
	pxTCB->pcTaskName[ ( unsigned short ) ( 16 ) - ( unsigned short ) 1 ] = '\0';

	
 
	if( uxPriority >= ( ( unsigned long ) 6 ) )
	{
		uxPriority = ( ( unsigned long ) 6 ) - 1;
	}
	...
	( &( pxTCB->xEventListItem ) )->xItemValue = ( ( unsigned long ) 6 ) - ( portTickType ) uxPriority;
...
#line 1929 "..\\..\\..\\Source\\tasks.c"

static void prvInitialiseTaskLists( void )
{
unsigned long uxPriority;

	for( uxPriority = 0; uxPriority < ( ( unsigned long ) 6 ); uxPriority++ )
	{
...
static void prvCheckTasksWaitingTermination( void )
{

	{
		...
		if( uxTasksDeleted > ( unsigned long ) 0 )
		{
			vTaskSuspendAll();
			...
			if( !xListIsEmpty )
			{
				...
				vPortEnterCritical();
				{
					pxTCB = ( tskTCB * ) ( ( ( ( xList * ) &xTasksWaitingTermination )->uxNumberOfItems != ( unsigned long ) 0 ) ? ( (&( ( ( xList * ) &xTasksWaitingTermination )->xListEnd ))->pxNext->pvOwner ) : ( 0 ) );
					vListRemove( &( pxTCB->xGenericListItem ) );
					--uxCurrentNumberOfTasks;
					--uxTasksDeleted;
				}
...
tskTCB *pxNewTCB;
	...
	if( pxNewTCB != 0 )
	{
		...
		else
		{
			...
			memset( pxNewTCB->pxStack, ( 0xa5 ), usStackDepth * sizeof( unsigned long ) );
		}
	}
...
#line 2058 "..\\..\\..\\Source\\tasks.c"
 

#line 2108 "..\\..\\..\\Source\\tasks.c"
 

#line 2128 "..\\..\\..\\Source\\tasks.c"
 

#line 2156 "..\\..\\..\\Source\\tasks.c"
...
#line 2217 "..\\..\\..\\Source\\tasks.c"
	...
	tskTCB * const pxTCB = ( tskTCB * ) pxMutexHolder;
		...
		if( pxTCB->uxPriority < pxCurrentTCB->uxPriority )
		{
			...
			( &( pxTCB->xEventListItem ) )->xItemValue = ( ( unsigned long ) 6 ) - ( portTickType ) pxCurrentTCB->uxPriority;

			
 
			if( ( ( &( pxTCB->xGenericListItem ) )->pvContainer == ( void * ) &( pxReadyTasksLists[ pxTCB->uxPriority ] ) ) )
			{
				vListRemove( &( pxTCB->xGenericListItem ) );
	...
	tskTCB * const pxTCB = ( tskTCB * ) pxMutexHolder;
		...
		if( pxMutexHolder != 0 )
		{
			if( pxTCB->uxPriority != pxTCB->uxBasePriority )
			{
				...
				( &( pxTCB->xEventListItem ) )->xItemValue = ( ( unsigned long ) 6 ) - ( portTickType ) pxTCB->uxPriority;
				{ if( pxTCB->uxPriority > uxTopReadyPriority ) { uxTopReadyPriority = pxTCB->uxPriority; } vListInsertEnd( ( xList * ) &( pxReadyTasksLists[ pxTCB->uxPriority ] ), &( pxTCB->xGenericListItem ) ); };
			}
		}
	}
...
#line 2290 "..\\..\\..\\Source\\tasks.c"
 

#line 2311 "..\\..\\..\\Source\\tasks.c"
